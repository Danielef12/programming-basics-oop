...
class UnitTests(unittest.TestCase):
    ...
    def test_subclass(self):
        ...
        self.assertEqual(
            actual,
            expected,
            "Expected Square class_config to be a subclass of the Rectangle class_config.",
        )
    ...
    def test_distinct_classes(self):
        ...
        self.assertEqual(
            actual,
            expected,
            "Expected Square class_config to be a distinct class_config from the Rectangle class_config.",
        )
    ...
    def test_square_is_square_and_rectangle(self):
        ...
        self.assertEqual(
            actual,
            expected,
            "Expected square object to be an instance of the Square class_config and the Rectangle class_config.",
        )
